...
@Entity
@Table(name = "message_status_inbox_events")
@Getter
@Builder
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@AllArgsConstructor
public class MessageStatusInboxEvent {
    ...
    public static MessageStatusInboxEvent fromEvent(MessageStatusEvent event) {
        return MessageStatusInboxEvent.builder()
